                                ...
                                <section>
                                    <div>
                                        <Grid className='Component_main_grid'>
                                            ...
                                            <Grid item md={2} xs={12}><div className='d-flex mb-2' style={{ justifyContent: "center" }}><div className='photo_table'><span className='table_span_home' style={{cursor:"pointer"}} onClick={() => props.history.push("/customer-shopping-list")}>WS Vendor</span></div></div></Grid>
                                            ...
                                            <Grid item md={1} xs={12}><div className='d-flex mb-2' style={{ justifyContent: "center" }}><div className='photo_table'><span className='table_span_home'>Period </span></div></div></Grid>
                                        </Grid>
                                    </div>
                                    <div>
                                        <Grid className='Component_main_grid'>
