                            ...
                            <Grid item md={6} xs={12}>
                                ...
                                <Card className="Card_shadow  m-5">
                                    ...
                                    <div className="card_color_customer_vender p-3">
                                        <h4 className='text-center mt-2 mb-4' style={{ color: "#fff", fontSize: "30px" }}>WS Vendor Add/Edit Distributer Log-In</h4>
                                        ...
                                        <div>
                                            <Grid className='Component_main_grid'>
                                                <Grid item md={8}>
                                                    ...
                                                    <div className='mt-5 text-right' onClick={() => props.history.push("#")}>
                                                        <button type="button" class="customer_distri">Ad another Distributor</button>
                                                    </div>
                                                </Grid>
                                                <Grid item md={4}>
                                                    <div className='mt-5 text-right' onClick={() => props.history.push("/venderItemList")}>
