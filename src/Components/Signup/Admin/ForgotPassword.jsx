...
const ForgotPassword = (props) => {
  ...
  const [emailveryfy, setemailveryfy] = useState("");
      ...
      axios
        ...
        .then(
          (res) => {
            ...
            props.history.push("/VeryfyPassword",{email:emailveryfy})
                    ...
                    <div className='pl-4 pr-4'>
                      ...
                      <div className="col-md-12 pb-3">
                        <input
                          ...
                          value={emailveryfy}
                          onChange={(e) => setemailveryfy(e.target.value)}
                        />
                      </div>
                    </div>
                ...
                <div className="customer mt-3 mb-3 text-center pt-2 pb-2" >
                  ...
                  <span className='new_customer text-center pl-2 pr-2'>New Wholeselers Sign-Up</span>
                    ...
                    <div className='mt-5 text-right'>
                      <button type="button" class="btn btn-success" onClick={passwordforgot}>Next<i class="fa fa-arrow-right pl-2"></i></button>
                    </div>
                  </div>
